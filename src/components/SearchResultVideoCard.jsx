        ...
        <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
            ...
            <div className="flex items-center">
                <div className="flex items-start mr-3">
                    <div className="flex h-8 w-8 md:h-9 md:w-9 rounded-full overflow-hidden">
                        <img
                            className="h-full w-full object-cover"
                ...
                <div className="flex flex-col">
                    <span className="text-xs md:text-sm font-semibold mt-2 text-white/[0.7] flex items-center">
                        {video?.author?.title}
                    ...
                    <div className="flex text-xs md:text-sm font-semibold text-white/[0.7] truncate overflow-hidden">
                        <span>{`${abbreviateNumber(
                            video?.stats?.views,
                            2
                        )} views`}</span>
                        <span className="flex text-[20px] md:text-[24px] leading-none font-bold text-white/[0.7] relative top-[-10px] mx-1">
                            .
                        </span>
